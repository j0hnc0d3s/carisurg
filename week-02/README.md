...
carisurg-portfolio/
├── week-00/
│   ├── notebooks/          # Assignments 01–04 (data cleaning + visualisation)
│   ├── docs/               # Assignments 05–06 (vital sign write-ups)
│   └── README.md
├── week-01/
│   ├── docs/               # Assignments 07–08 (literature review + proposal)
│   └── README.md
├── week-02/
│   ├── docs/               # Assignment 09 (updated proposal)
│   └── README.md
├── data/
│   └── README.md           # Dataset provenance note
├── .gitignore
├── LICENSE
├── requirements.txt
└── README.md
...
- `*.csv` — dataset files (de-identified triage data not committed)
